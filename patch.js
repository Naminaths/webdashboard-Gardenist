...
const run_auto_orig = `        if (c?.pump?.enabled) {
...
const run_auto_new = `        const schedEnabled = document.getElementById('schedule-pump-enable')?.checked;
...
console.log('Patched src/main.js successfully.');
